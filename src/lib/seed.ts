...
export const SEED_ACCOUNTS: Account[] = [
  { id: 'a-default', name: '기본 지갑', bank: '내 지갑', type: 'cash', balance: 0, color: '#00B956', main: true, scope: 'personal' },
  { id: 'b-default', name: '사업 통장', bank: '내 사업', type: 'cash', balance: 0, color: '#3182F6', main: true, scope: 'business' },
];
