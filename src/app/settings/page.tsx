    ...
    <>
      ...
      {(() => {
        ...
        const businessManagement = (
          <Section title={mode === 'business' ? '사업자' : '사업자 (사업 모드 전환 후 사용)'} key="business">
        ...
        return mode === 'business' ? [businessManagement, personalManagement] : [personalManagement, businessManagement];
      })()}
